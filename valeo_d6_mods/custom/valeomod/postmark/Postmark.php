...
class Mail_Postmark
{
	...
	*/
	...
	{
		$this->_default('POSTMARKAPP_MAIL_FROM_NAME', 'Valeo Price Alerts');
		$this->_default('POSTMARKAPP_MAIL_FROM_ADDRESS', 'alerts@valeopartners.com');
		$this->_default('POSTMARKAPP_API_KEY', 'b8ea7300-0868-4189-a509-ba446d4184b9');
