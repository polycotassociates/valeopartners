...
class ExportHeader extends AreaPluginBase {
  ...
  private function make_links(){
    ...
    $export_csv = "$path/export?$query=&_format=xls";
    // html for link
    ...
    $export_csv_link = "<span id='export-csv-link'><span class='vsv-icon'>&nbsp;</span><a href='$export_csv'><img src='/themes/custom/valeo_classic/images/csv-24.png' />Export CSV</a></span>";
