 ...
 *
 * @ViewsArea("export_transactions_by_firm")
 */
class ExportTransactionsByFirmHeader extends AreaPluginBase {
  ...
  private function makeLinks() {
    ...
    if (in_array("download_add_on", $user->getRoles()) || in_array("administrator", $user->getRoles()) || in_array("superuser", $user->getRoles())) {
      ...
      $export_xls = "/reports/export/transactions-by-firm?report_title=$report_title&$query";
