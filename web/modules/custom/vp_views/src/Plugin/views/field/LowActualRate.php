...
/**
 * @file
 * Definition of Drupal\vp_views\Plugin\views\field\LowActualRate.
 */
...
/**
 * Gets the lowest rate given a position/rate/firm.
 *
 * @ingroup views_field_handlers
 *
 * @ViewsField("low_actual_rate")
 */
class LowActualRate extends FieldPluginBase {
    ...
    switch ($bundle) {
      case "vp_type_rate":
        ...
        if ($filing) {
          ...
          $results = $this->getLowActualRate($rate_year, $position, $firm);
        }
        else {
          $results = 0;
        }
   ...
   */
  private function getLowActualRate($rate_year, $position, $firm) {
    ...
    $query->orderBy('field_vp_rate_hourly_value', 'ASC');
