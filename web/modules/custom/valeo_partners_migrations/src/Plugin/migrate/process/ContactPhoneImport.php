...
class ContactPhoneImport extends ProcessPluginBase {
  public function transform($value, MigrateExecutableInterface $migrate_executable, Row $row, $destination_property) {

    $number = $value['number'];
    $extension = $value['extension'];
    $country_code = $value['country_codes'];

    $code = $this->country_code($country_code);

    $new_number = $code . $number;
    return $new_number;
